...
import upo.tad.g11.proyecto.tad.controller.ControladorServicio;
import upo.tad.g11.proyecto.tad.model.entity.Hotel;
import upo.tad.g11.proyecto.tad.model.entity.Servicio;
import upo.tad.g11.proyecto.tad.view.form.ServicioForm;

@Theme("mytheme")
@Title("Servicios")
public class GestionServicios extends UI {

    Controlador controladorS = new ControladorServicio();
 ...
 /*--------------------TABLA (read, update, delete)--------------------*/
        ...
        BeanItemContainer<Servicio> beans
                = new BeanItemContainer<>(Servicio.class);
        ...
        Object[] VISIBLE_COLUMN_IDS = new String[]{"nombre", "descripcion", "horario", "tarifa", "hotel.nombre",};
        ...
        beans.addAll(controladorS.listar());
    }

    @WebServlet(value = {"/servicios/*"}, name = "GestionServicios", asyncSupported = true)
    @VaadinServletConfiguration(productionMode = false, ui = GestionServicios.class)
    public static class GestionServiciosServlet extends VaadinServlet {
    }
}
